...
function svgBarChart(items: Array<{ label: string; value: number; color: string }>): string {
...
function commandBridge(label: string, command: string): string {
  return `
...
export function generateReportHtml(pluginRoot: string, analysis: AnalysisResult): void {
